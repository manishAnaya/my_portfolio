...
List<ProjectModel> myProjects = [
  ProjectModel(
      title: 'Spires Recruit - Online Job & Internship Platform',
      description:
      ...
      link: 'https://play.google.com/store/apps/details?id=com.atc.spires_app'),
  ProjectModel(
      title: 'Stylishe Collection - E-commerce App',
      description:
          'Created a seamless online clothes and home essentials shopping app with secure payment gateways and personalized user accounts. Implemented Getx State management to manage the shopping cart and user preferences.',
      link: 'https://play.google.com/store/apps/details?id=com.act.clothes'),
  ProjectModel(
      ...
      link: 'https://play.google.com/store/apps/details?id=com.atc.edunear'),
  ProjectModel(
      ...
      link: 'https://play.google.com/store/apps/details?id=com.atc.kabia'),
  ProjectModel(
      ...
      link: 'https://play.google.com/store/apps/details?id=com.ve_decore.com'),
  ProjectModel(
      ...
      link: 'https://play.google.com/store/apps/details?id=com.atc.pinghr'),
  ProjectModel(
      ...
      link: 'https://play.google.com/store/apps/details?id=com.atc.briio'),
  ProjectModel(
  ...
  ProjectModel(
      ...
      link: 'https://play.google.com/store/apps/details?id=com.atc.schoolmgt'),
];
